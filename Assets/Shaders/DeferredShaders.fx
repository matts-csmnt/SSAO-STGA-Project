...
struct DecalVertexShaderOutput
{
	float4 Position : POSITION0;
...
DecalVertexShaderOutput DecalVertexShader(DecalVertexShaderInput input)
{
	DecalVertexShaderOutput output;

	return output;
}

float4 DecalPixelShader(DecalVertexShaderOutput input)
{
