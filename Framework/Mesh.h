...
public:
	...
	ID3D11Buffer* vertex_buffer_notconst() { return m_pVertexBuffer; }
	ID3D11Buffer* index_buffer_notconst() { return m_pIndexBuffer; }

	void set_vertex_buffer(ID3D11Buffer* b) { m_pVertexBuffer = b; }
	void set_index_buffer(ID3D11Buffer* b) { m_pIndexBuffer = b; }

	u32 vertices() const { return m_vertices; }
	u32 indices() const { return m_indices; }

	void set_vertices(u32 v) { m_vertices = v; }
	void set_indices(u32 i) { m_indices = i; }
