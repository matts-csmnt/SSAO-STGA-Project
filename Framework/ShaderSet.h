...
struct ShaderSetDesc
{
	...
	static ShaderSetDesc Create_VS_GS_PS(const char* fName, const char* vsEntry, const char* gsEntry, const char* psEntry)
	{
		ShaderSetDesc desc = {};
		desc.filename = fName;
		desc.entryPoints[ShaderStage::kVertex] = vsEntry;
		desc.entryPoints[ShaderStage::kPixel] = psEntry;
		desc.entryPoints[ShaderStage::kGeometry] = gsEntry;
		return desc;
	}
};
